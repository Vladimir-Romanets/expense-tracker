...
- If the path starts with `apps/web/`, that's your zone, continue.
- If the path starts with `apps/api/`, stop; that's not your skill; this task belongs to the backend reviewer.
